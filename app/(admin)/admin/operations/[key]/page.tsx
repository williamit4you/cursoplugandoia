...
import NewsAnalyticsDashboard from "@/components/NewsAnalyticsDashboard";
...
export default async function OperationDetailPage({ params }: { params: { key: string } }) {
  ...
  const isNewsOperation = operation.key === "NEWS_CONTENT";
  return <div className="mx-auto max-w-6xl space-y-6 pb-16">
    ...
    {isNewsOperation ? <NewsAnalyticsDashboard /> : null}
