...
export default function AdminDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { text: "Resumo Noticias", icon: <ArticleIcon className="text-indigo-500" />, path: "/admin/resumo-noticias" },
    ...
    { text: "Publicações", icon: <VideoCameraBackIcon />, path: "/admin/social" },
    { text: "Calendário", icon: <EventIcon />, path: "/admin/social/calendar" },
    ...
    { text: "Execucoes", icon: <PlayArrowIcon />, path: "/admin/task-runs" },
    ...
    { text: "Posts de Tecnologias", icon: <ArticleIcon className="text-blue-600" />, path: "/admin/technical-content-analytics" },
    ...
    { text: "Programas Afiliados", icon: <ArticleIcon className="text-green-700" />, path: "/admin/programas-afiliados" },
    { text: "SEO Pet - Cobasi", icon: <ArticleIcon className="text-green-700" />, path: "/admin/seo-pet-cobasi" },
  ];

  const growthPaths = new Set(["/admin/youtube-analytics", "/admin/bio-analytics", "/admin/whatsapp-promocoes", "/admin/sales-analytics", "/admin/course-analytics", "/admin/technical-content-analytics", "/admin/compra-esperta", "/admin/operations/NEWS_CONTENT", "/admin/editorial-commerce", "/admin/programas-afiliados", "/admin/seo-pet-cobasi", "/admin/comparativos", "/admin/propagandas"]);
