    ...
    >
      <div style={{ width: "100%", maxWidth: 1200, opacity: fade * exit }}>
        ...
        <div style={{ position: "relative", paddingLeft: 28 }}>
          <div style={{ position: "absolute", left: 10, top: 4, bottom: 4, width: 4, borderRadius: 999, background: "rgba(255,255,255,0.15)" }} />
            ...
            {items.map((it, idx) => {
              ...
              return (
                <div key={idx} style={{ display: "flex", gap: 14, alignItems: "flex-start", transform: `translateY(${(1 - enter) * 14}px)`, opacity: enter }}>
                  <div style={{ width: 22, height: 22, borderRadius: 999, background: "linear-gradient(135deg, #22c55e, #7c3aed)", marginLeft: -2, marginTop: 8, flexShrink: 0 }} />
                  <div>
