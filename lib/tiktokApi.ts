...
async function runUploaderCli(
  ...
  if (usePythonRunner) {
    const runnerScript = [
      ...
      "    ]",
      "",
      "    print('[TikTok] Tentando clicar no botao de publicar')",
      "    for selector in candidates:",
      "        try:",
      "            locator = page.locator(selector).first",
      "            if locator.count() > 0 and locator.is_visible():",
      "                print(f'[TikTok] Botao encontrado por seletor: {selector}')",
      ...
      "",
      "    try:",
      "        print('[TikTok] Tentando botao por role/name: Post')",
      ...
      "",
      "    try:",
      "        print('[TikTok] Tentando botao por role/name: Publish')",
      ...
      "\"\"\")",
      "    if clicked:",
      "        print('[TikTok] Clique via evaluate() executado')",
      "        page.wait_for_timeout(1500)",
      "        return",
      "",
      ...
      "            print('[TikTok] Saiu da tela de upload para a area de gerenciamento')",
      "            return",
      "",
      "        if not button_still_visible and any(snippet in page_text for snippet in weak_snippets):",
      "            print('[TikTok] TikTok ainda processando o envio...')",
      "            continue",
      "",
      "        if button_still_visible:",
      "            print('[TikTok] Botao ainda visivel; aguardando confirmacao sem clicar novamente')",
      "            continue",
      "",
      "    print(f'[TikTok] URL final sem confirmacao: {page.url}')",
      "    print(f'[TikTok] Trecho da tela: {page_text[:500]}')",
